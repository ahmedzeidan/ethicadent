...
export function PhoneIcon({ size = 16 }: IconProps) {
  return (
    <svg aria-hidden="true" width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path
        d="M6.5 4h2.2c.6 0 1.1.4 1.2 1l.4 2.4a1.2 1.2 0 0 1-.3 1.1l-1.4 1.4a12.5 12.5 0 0 0 5.5 5.5l1.4-1.4a1.2 1.2 0 0 1 1.1-.3l2.4.4c.6.1 1 .6 1 1.2v2.2a1.2 1.2 0 0 1-1.1 1.2C10.8 20.1 3.9 13.2 3.8 7.1A1.2 1.2 0 0 1 5 6h1.5Z"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
...
export function FacebookIcon({ size = 20 }: IconProps) {
  return (
    <svg aria-hidden="true" width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M13.5 9.5V7.8c0-.7.5-1.1 1.2-1.1h1.6V4h-2.2c-2.4 0-3.6 1.3-3.6 3.8v1.7H8v2.7h2.5V20h3V12.2h2.4l.4-2.7H13.5Z" />
    </svg>
  );
}
...
export function YelpIcon({ size = 20 }: IconProps) {
  return (
